...
public class LanternfishCounterTest {
  ...
  public void test_01() {
    ...
    Assertions.assertEquals(350605, counter2.getLanternfish());
  }
  ...
  public void test_02() {
    ...
    Assertions.assertEquals(26984457539L, counter3.getLanternfish());
  }
  ...
  public void test_03() {
    ...
    Assertions.assertEquals(1592778185024L, counter4.getLanternfish());
  }
